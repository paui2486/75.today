...
<html lang="zh_tw">
  ...
  <head>
    ...
    <meta property="og:title" content="iWine嚴選好康團購">
                  ...
                  <table width="100%" border="1" cellspacing="1" cellpadding="5" style="border:#C7B299">
                    ...
                    <tr>
                      <td><table width="100%" border="0" cellspacing="1" cellpadding="5">           
                        ...
                        <tr>
                          <td align="center"><h4><span style="color:#FC91A2">團購價：<?php if($row_newgroup['p_login_price']=="Y"){if($_SESSION['MEM_ID']<>""){echo "NT$".$row_newgroup['p_price2'];}else{ echo "請先登入會員"; }}else{ echo "NT$".$row_newgroup['p_price2'];} ?></span></h4></td>
                        </tr>
                        <tr>
                        ...
                        <?php /*start db_input script*/ if ($row_newgroup['p_outside'] == "N"){ ?>
                          ...
                          <tr>
                            <td align="center">限量<?php if($row_newgroup['p_limit_num'] > 0) {echo $row_newgroup['p_limit_num'];} else {echo "0";} ?>份，已登記 <?php if($row_newgroup['p_sale_num'] > 0){ echo $row_newgroup['p_sale_num'];} else {echo "0"; }?> 份</td>
                          </tr>
                            <?php }else{ ?>
                          <tr>
                            <td align="center">目前已登記 <?php if($row_newgroup['p_sale_num'] > 0 ){ echo $row_newgroup['p_sale_num'];} else {echo "0";} ?> 份</td>
                          </tr>
                          <?php } 
