...
<script>(function(d, s, id) {
  ...
  fjs.parentNode.insertBefore(js, fjs);
          ...
          <div class="row">
            <div class="span9">
              <div>
                <div class="row">
           			<div class="span9">
                		<h3><img src="images/wine_icon1.png" width="49" height="49"> <span class="title">影片</span><span class="span8"></span></h3> <img src="images/line03.png" width="1000">
                    </div>
                </div>
                <div class="row">
           			<div class="span9">
    ...
    <div id="container_w">    
	  <?php do { ?>
        <div class="item_w2">
        <div style="border:solid 0px #000000; margin-bottom:5px; padding:5px; background-color:#fdf0f1">
		<a href="cute_video_detail.php?n_id=<?php echo $row_article['n_id']; ?>" >
        <img src="http://admin.iwine.com.tw/webimages/video/<?php echo $row_article['n_fig1']; ?>" alt="<?php echo $row_article['n_title']; ?>" width="400">
        </a>
          <h4><?php echo $row_article['n_title']; ?></h4>
          <div align="center" style=" margin-bottom:10px"><a href="cute_video_detail.php?n_id=<?php echo $row_article['n_id']; ?>" class="btn btn-small btn-primary"><i class="icon-search icon-white"></i>看影片</a></div>
            <div class="fb-like" data-href="http://www.iwine.com.tw/cute_video_detail.php?n_id=<?php echo $row_article['n_id']; ?>" data-layout="button_count" data-show-faces="false" data-send="true"></div>
          </div>
          </div>
