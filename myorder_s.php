          ...
          <table class="table table-striped table-bordered">
						  <tbody>
							...
							<tr>
							  ...
							  <td><?php echo $row_Recordset1['p_price2']; ?>元</td>
						    </tr>
							<tr>
							  <td class="center">商品數量</td>
							  <td>  主要商品：<br>
                  ...
                  <?php } ?>
							...
							<tr>
							  ...
							  <td><?php echo $row_Recordset1['ord_buy_price']; ?>元</td>
						    </tr>
							<tr>
							  <td class="center">運費</td>
							  <td><?php echo $row_Recordset1['ord_ship_price']; ?>元</td>
						    </tr>
							<tr>
							  <td class="center">手續費</td>
							  <td><?php echo $row_Recordset1['ord_hand_price']; ?>元</td>
						    </tr>
							<tr>
							  <td class="center">合計</td>
							  <td><?php echo $row_Recordset1['ord_total_price']; ?>元</td>
						    </tr>
							<tr>
							  <td class="center">收貨人姓名</td>
							  <td><?php echo $row_Recordset1['ord_ship_name']; ?></td>
						    </tr>
							<tr>
							  <td class="center">收貨人地址</td>
							...
							<tr>
							  <td class="center">收貨人手機</td>
							  <td><?php echo $row_Recordset1['ord_ship_mobile']; ?></td>
						    </tr>
							<tr>
							  <td class="center">收貨人e-mail</td>
                        ...
                        <?php if($row_Recordset1['ord_pay'] == "atm_cathy"){ ?>
                        	<tr>
							  ...
							  <td style="color:#F00">匯款銀行代號與名稱：013 國泰世華銀行 松山分行<br>
                              	  戶名：共贏科技股份有限公司<br>
                                  匯款帳號：<?php echo $row_Recordset1['ord_atm_5code']; ?>
                              </td>
						    </tr>
                        <?php } ?>
							<tr>
						...
						switch($row_Recordset1['ord_status']){
							...
							break;
							case '2':
                                if($row_Recordset1['ord_pay'] == "card"){
                                    echo "付款失敗，請重新下單";
                                }else{
                                    echo "付款失敗";
                                }
							
							//echo "<a href=\"checkout_card_cathay.php?ord_code=".$row_Recordset1['ord_code']."\">我要重新付款</a>";
							break;
							case '3':
							echo "已付款，準備出貨中";
							break;
