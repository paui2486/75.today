<?php 
session_start(); //啟動sesssion 好懶喔
include('func/func.php'); 
$cur_url = curPageURL();
require_once('Connections/iwine.php'); //連線DB需要
...
<?php
	$sql ='SELECT * FROM `vedio` ORDER BY creat_time DESC limit 9';//搜尋語句 看要找哪個DB
...
<html lang="zh_tw">
  ...
  <head>
    <meta charset="utf-8">
    <title>影片情報 - iWine -- 禁止酒駕．未滿18歲禁止飲酒</title>
	...
	<?php include('header_20140903.php'); ?>
                    ...
                    <div>
                        ...
                        <div class="span9">
                            <!--<div class="title_uploadimg">
                                <div style="float:left;"><h3><img src="images/wine_icon1.png" width="35" height="35">影片情報</h3></div>
                                <div style="float:right; right:0px; top:0px; padding-top:20px;"><a href="video_upload.php" onclick="alert('請先登入會員，謝謝！');"><img src="images/新聞稿.png" width="117" height="33"></a></div>
                            </div>-->
		...
		<div class="ad_list" >
			<div class="number">
				<div class="pic">
				<!--tag-->
				<a href="video_view.php?id= <?php echo $row['id']; ?>"><img src="http://admin.iwine.com.tw/webimages/symposium/<?php echo $row['pic1']; ?>" width="250" height="193" border="0" title="更多影片情報" ></a>
				</div>
				<div class="title">
				<?php echo($row["title"]); ?>
				</div>
				   ...
				   <div style="z-index: 9999; overflow:hidden; height:20px; margin-top:-20px !important;">
						...
						<a href="#" onclick="window.open('https://www.facebook.com/sharer/sharer.php?u='+encodeURIComponent('http://www.iwine.com.tw/video_view.php?id=<?php echo $row['id']; ?>'),'facebook-share-dialog','width=626,height=436');return false;"><img src="images/fb.jpg"></a>
						</div>
...
<table>						
						<?php while($symposium = mysql_fetch_assoc($symposium_query)) {
                                           ...
                                           <?php }else{ ?><!-- 上面是活動時間已截止 以下這邊是活動列表 $symposium['id']活動ID $symposium['title']活動名稱-->
												...
												<!--<td><a href="symposium.php?id=<?php //echo  $symposium['id']; ?>" ><?php //substr_utf8(strip_tags($symposium['title']),40); ?></a></td>-->
