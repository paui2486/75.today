        ...
        <div id="MainContent" class="span9">
          <div class="row">
            <div class="span9">
              ...
              <div>
                <form action="member_pwd_check_b.php" method="post" class="form-horizontal" id="form1">
                    <legend class="title"><img src="images/wine_icon1.png" width="49" height="49">忘記密碼</legend>
                    ...
                    <div class="control-group">
                      <label class="control-label" for="account">帳 號</label>
                        <div class="controls">
                        <input type="text" id="account" name="account" placeholder="請輸入e-mail">
                        <span class="help-inline">*請輸入註冊時所填寫的e-mail帳號</span>
                        </div>
                  </div>
                    <div class="control-group">
                    ...
                    <div class="control-group">
                        ...
                        <button type="button" class="btn btn-success"><a href="login_b.php" style="color:#FFF">重新登入</a></button>
                        </div>
                        </div>
                </form>
