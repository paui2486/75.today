...
$updateSQL = "UPDATE order_list SET ord_status = '3', ord_card_response = '$errcode', ord_card_msg = '$errmsg' WHERE ord_code='$td'";
mysql_select_db($database_iwine, $iwine);
$Result1 = mysql_query($updateSQL, $iwine) or die(mysql_error());

	$why_success = "付款成功! 您可至查詢訂單選項中查詢訂單進度，謝謝";
	msg_box($why_success);
...
$updateSQL = "UPDATE order_list SET ord_status = '2', ord_card_response = '$errcode', ord_card_msg = '$errmsg' WHERE ord_code='$td'";
mysql_select_db($database_iwine, $iwine);
$Result1 = mysql_query($updateSQL, $iwine) or die(mysql_error());
