...
$query_member_check = sprintf("SELECT * FROM bar WHERE account = '%s'", GetSQLValueString($colname_member_check, "text"));
...
if($_POST['check_form'] == "Y"){ 
 ...
 $insertSQL = sprintf("INSERT INTO bar (account, password_md5, company_name, owner, contact, address, telphone, fax, email, vat_num, last_login, regist_date, mod_time, category, open_time, cons_pattems, products, pic1, pic2, pic3, pic4, pic5) 
...
mysql_select_db($database_iwine, $iwine);
$query_member = "SELECT * FROM bar WHERE id = '".$_new_m_id."'";
...
<table width=\"780\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">
  <tr>
    <td height=\"150\" align=\"center\" valign=\"middle\" background=\"http://www.iwine.com.tw/images/mail_bg.gif\"><table width=\"600\" border=\"0\" cellspacing=\"0\" cellpadding=\"5\">
      <tr>
        <td><p>親愛的 ".$_POST['company_name']." 您好：</p>
          <p> 感謝您加入成為本網站合作夥伴，請妥善保管本信，內含個人會員資訊！</p>
          <p>您申請的身分別是： 酒吧合作夥伴，登入時請選擇酒吧身分別。</p>
...
$address = $row_member['email'];
$mail->AddAddress($address, $_POST['company_name']);
