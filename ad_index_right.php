...
$query_AD01 = "SELECT * FROM ad_fig WHERE b_position = '3' AND b_status = 'Y' ORDER BY RAND() LIMIT 1";
...
<h4 align="left"><img src="images/wine_icon6.png" width="30" height="30"> 友好連結</h4>
   <div style="margin-bottom:10px; margin-left:10px; width:245px; height:300px; overflow:hidden; align="center">
