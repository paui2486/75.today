...
if (isset($_POST["check_form"])) {//這邊上傳 所發布的資料
  $title = $_POST['title'];
  $insertSQL = sprintf("INSERT INTO Press_release (title, creat_time, pic_1, Article)
                                               VALUES ('%s', '%s', '%s', '%s')",
  ...
  $_new_id = mysql_insert_id();
    ...
    <body>Hi <br>會員".$_SESSION['MEM_NAME']."(".$_SESSION['MEM_ACCOUNT'].")已經新增新聞稿訊息 「<b> ".$title." </b>」。<br><br>
...
<html lang="zh_tw">
  ...
  <head>
    <meta charset="utf-8">
    <title> 上傳新聞稿情報 - iWine -- 禁止酒駕．未滿18歲禁止飲酒</title>
      ...
      <div class="row container-area">
            ...
            <div class="span9">
              ...
              <div>
                <form action="<?php echo $editFormAction;?>" method="post" enctype="multipart/form-data" class="form-horizontal" id="form1" >
                    <img src="images/wine_icon1.png" width="35" height="35"><span class="title">上傳新聞稿資料</span><img src="images/line03.png" width="1000">
				  ...
				  <div class="control-group">
                      <label class="control-label" for="start_date">編輯時間</label>
                        <div class="controls">
        ...
        //});
                 ...
                 <!-- <div class="control-group">
					...
					<div class="control-group">
                        <label class="control-label" for="pic_1"><span class="memo">*</span>上傳新聞稿封面照片</label>
                        <div class="controls">
