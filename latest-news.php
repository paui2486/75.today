...
if (isset($_GET['id'])) {
	$id = $_GET['id'];
mysql_select_db($database_iwine, $iwine);
$sql ="SELECT * FROM `Press_release` where id = '$id'";//搜尋語句
...
<html lang="zh_tw">
  ...
  <head>
    <meta charset="utf-8">
    <title><?php echo $row['title']; ?> - iWine -- 禁止酒駕．未滿18歲禁止飲酒</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <!--<meta name="description" content="<?php //echo substr_utf8(strip_tags($result['cont']),200) ;?>...">-->
    <meta name="author" content="">
    <meta property="og:title" content="<?php echo $row['title']; ?> -- 禁止酒駕．未滿18歲禁止飲酒">
    <meta property="og:site_name" content="iWine">
    <meta property="og:image" content="http://www.iwine.com.tw/webimages/symposium/<?php echo $row['pic_1']; ?>">
        ...
        <div id="MainContent" class="span9">
          <!--div class="row">
            ...
            <ul class="breadcrumb">
                ...
                <li><a href="latest-news-list.php">品牌情報</a> <span class="divider">/</span></li>
                <li class="active"><?php echo $row['title']; ?></li><!--標題-->
            </ul>
            ...
            <div class="row" style="border:#000000 solid 0px; margin-left:0px; margin-bottom:10px">
                ...
                <div class="span8">
                    <h2><img src="images/wine_icon1.png" width="35" height="35">品牌情報</h2>
...
<div class="span8" style="display: block; overflow:hidden;">
	...
	<div style="float:left; z-index: 999;"><!--fb分享--><!--注意分享網址 資料庫欄位-->
        <a href="#" onclick="window.open('https://www.facebook.com/sharer/sharer.php?u='+encodeURIComponent('http://www.iwine.com.tw/latest-news.php?id=<?php echo $row['id']; ?>'),'facebook-share-dialog','width=626,height=436');return false;"><img src="images/fb.png"></a>
    </div>
                ...
                <div class="span8" style="padding:0px">
					...
					$url = 'http://www.iwine.com.tw/webimages/symposium/'.$row['pic_1'].'';//原始圖位置
						...
						echo "http://admin.iwine.com.tw/webimages/article/".$row['pic_1'];//修改圖位置 後台資料夾
                            ...
                            <?php                            
							for($i=2; $i<=5; $i++){
                                $current_file_name= 'pic_1'.$i; 
                                $current_file_path = "../web/webimages/symposium/".$row[$current_file_name];
                                if (is_file($current_file_path)){
                                    echo "<span class=\"article_txt\" style=\"margin-top:20px; margin-bottom:50px\"><img src=\"http://www.iwine.com.tw/webimages/symposium/".$row['pic_1']."\" width=\"191\" height=\"191\"></span>";
                                }
                            }?>
                    ...
                    <div class="row">
                        ...
                        <div class="span12">
                          <?php if($totalRows_other > 0){ ?>
                              <h4><br>
                              <img src="images/wine_icon1.png" width="35" height="35"> <span class="title">更多新聞稿：</span><br><!-- 改成更多新聞稿-->
                              </h4>
                              <?php do { ?>
                              <div class="span3">
                                <div style="border:solid 0px #000000; margin-bottom:20px;">
                                  <div style="height:199px; overflow:hidden"> 
                                    <a href="symposium.php?id=<?php echo $row_other['id']; ?>" > 
                                        <img src="http://www.iwine.com.tw/webimages/symposium/<?php echo $row_other['pic_1']; ?>" alt="<?php echo $row_other['title']; ?>" > 
                                    </a> 
                                  </div>
                                  <div style="height:30px">
                                    <h5><a href="symposium.php?id=<?php echo $row_other['id']; ?>"><?php echo $row_other['title']; ?></a></h5>
