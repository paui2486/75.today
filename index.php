...
<?php if ($totalRows_hotest_expert > 0) { // Show if recordset not empty ?>    
          ...
          <div style="margin-bottom:5px; padding:5px;">
            ...
            <div style="display:inline-block; z-index: 9999; overflow:hidden; height:20px;">
                <div style="float:left; ">
                    <a href="#" onclick="window.open('https://www.facebook.com/sharer/sharer.php?u='+encodeURIComponent('http://www.iwine.com.tw/expert_article.php?n_id=<?php echo $row_hotest_expert['n_id']; ?>'),'facebook-share-dialog','width=626,height=436');return false;"><img src="images/facebook-icon.png"></a>
                </div>
      ...
      <?php do { ?>
        <div class="span3">
          <div style="margin-bottom:5px; padding:5px;">
            ...
            <div style="display:inline-block; z-index: 9999; overflow:hidden; height:20px;">
                <div style="float:left; ">
                    <a href="#" onclick="window.open('https://www.facebook.com/sharer/sharer.php?u='+encodeURIComponent('http://www.iwine.com.tw/article.php?n_id=<?php echo $row_hotest_article['n_id']; ?>'),'facebook-share-dialog','width=626,height=436');return false;"><img src="images/facebook-icon.png"></a>
                </div>
                <div style="float:left;padding-left:5px; z-index: 999; color:#949494; vertical-align:bottom;margin-top:1px;">
  ...
  <?php } ?>
      ...
      <?php do { ?>
        <div class="span3">
          <div style="margin-bottom:5px; padding:5px;">
            <div style="height:145px; overflow:hidden"> <a href="expert_article.php?n_id=<?php echo $row_newest_expert['n_id']; ?>" > <img src="http://007.style/admin/webimages/article/<?php echo $row_newest_expert['n_fig1']; ?>" alt="<?php echo $row_newest_expert['n_title']; ?>"> </a> </div>
            <div style="height:50px; overflow:hidden">
            ...
            <div style="display:inline-block; z-index: 9999; overflow:hidden; height:20px;">
                <div style="float:left; ">
                    <a href="#" onclick="window.open('https://www.facebook.com/sharer/sharer.php?u='+encodeURIComponent('http://www.iwine.com.tw/expert_article.php?n_id=<?php echo $row_newest_expert['n_id']; ?>'),'facebook-share-dialog','width=626,height=436');return false;"><img src="images/facebook-icon.png"></a>
                </div>
                <div style="float:left;padding-left:5px; z-index: 999; color:#949494; vertical-align:bottom; margin-top:1px;">
  ...
  <?php } ?>  
      ...
      <?php do { ?>    
        ...
        <div style="display:inline-block; z-index: 9999; overflow:hidden; height:20px;">
                <div style="float:left; ">
                    <a href="#" onclick="window.open('https://www.facebook.com/sharer/sharer.php?u='+encodeURIComponent('http://www.iwine.com.tw/article.php?n_id=<?php echo $row_newest_article['n_id']; ?>'),'facebook-share-dialog','width=626,height=436');return false;"><img src="images/facebook-icon.png"></a>
                </div>
