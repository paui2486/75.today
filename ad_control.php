...
$query_AD01 = "SELECT * FROM ad_fig WHERE b_position = '".$_position."' AND b_status = 'Y' ORDER BY RAND() LIMIT 1";
...
<?php if ($totalRows_AD01 > 0) { // Show if recordset not empty ?>
   <div style="margin-bottom:10px;" align="center">
     <a href="hit_ad.php?b_id=<?php echo $row_AD01['b_id']; ?>"><img src="http://admin.iwine.com.tw/webimages/ad/<?php echo $row_AD01['b_file']; ?>" /></a>
  </div>
