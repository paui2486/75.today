...
if ($securimage->check($_POST['capacha_code']) == false) {
  msg_box('驗證碼錯誤,請重新輸入!');
  $_err_url = "regist_bar_simple.php";
  go_to($_err_url);
  exit;
}
...
if($_POST['check_form'] == "Y"){ 
 ...
 $insertSQL = sprintf("INSERT INTO bar (account, password_md5, email, last_login, regist_date, mod_time, company_name ) 
