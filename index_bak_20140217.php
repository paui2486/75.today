...
<?php if ($totalRows_newest_expert > 0) { // Show if recordset not empty ?>    
        ...
        <div class="span3">
          <div style="margin-bottom:5px; padding:5px;">
            ...
            <div style="display:inline-block; z-index: 9999; overflow:hidden; height:20px;">
                ...
                <?php echo $row_newest_expert['view_counter']; ?> 人次點閱
                </div>
            </div>
            <!-- fb like, fb share, twitter, g+ -->
            <!--div style="display:inline-block; z-index: 9999; overflow:hidden; height:20px;">
                <div style="">
                    <div class="fb-like" style="position: absolute; margin-top:-0px; margin-left:5px; overflow:hidden !important; z-index: 999; width:90px !important;" data-href="http://www.iwine.com.tw/article.php?n_id=<?php echo $row_newest_expert['n_id']; ?>" data-layout="button_count" data-action="like" data-show-faces="false" data-share="false" data-width="90"></div>
                    
                </div>
                <div style="float:left; padding-left:90px; z-index: 999;">
                    <a href="#" onclick="window.open('https://www.facebook.com/sharer/sharer.php?u='+encodeURIComponent('http://www.iwine.com.tw/article.php?n_id=<?php echo $row_newest_expert['n_id']; ?>'),'facebook-share-dialog','width=626,height=436');return false;"><img src="images/fb.jpg"></a>
                </div>
                <div style="float:left; z-index: 9999; display: inline;">
                    <a href="https://twitter.com/share" class="twitter-share-button" data-url="http://www.iwine.com.tw/article.php?n_id=<?php echo $row_newest_expert['n_id'];?>" data-via="draqula" data-lang="zh-tw" data-count="none">推文</a>
                        <script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0],p=/^http:/.test(d.location)?'http':'https';if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src=p+'://platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document, 'script', 'twitter-wjs');</script>
                </div>
                <div style="float:left; padding-left:5px; z-index: 9999; display: inline;">
                <div class="g-plusone" data-annotation="none" data-href="http://www.iwine.com.tw/article.php?n_id=<?php echo $row_newest_expert['n_id'];?>"></div>

                </div>
                
            </div-->
            
            <!--div align="right" style="position: absolute; z-index: 9999; overflow:visible; margin-top:-20px; margin-left:100px"> <a href="#" onclick="window.open('https://www.facebook.com/sharer/sharer.php?u='+encodeURIComponent('http://www.iwine.com.tw/article.php?n_id=<?php echo $row_newest_article['n_id']; ?>'),'facebook-share-dialog','width=626,height=436');return false;"><img src="images/fb.jpg"></a> </div>
            <div class="fb-like" style="position: absolute; z-index: 9999; overflow:visible; margin-top:-20px; margin-left:70px" data-href="http://www.iwine.com.tw/article.php?n_id=<?php echo $row_newest_expert['n_id']; ?>" data-layout="button_count" data-show-faces="false" data-send="false" data-width="50"></div>
            <!--div align="right" style="position: absolute; z-index: 99999; overflow:visible; margin-top:-20px; margin-left:135px;">
                <a href="https://twitter.com/share" class="twitter-share-button" data-url="http://www.iwine.com.tw/article.php?n_id=<?php echo $row_newest_expert['n_id'];?>" data-via="draqula" data-lang="zh-tw" data-count="none">推文</a>
                    <script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0],p=/^http:/.test(d.location)?'http':'https';if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src=p+'://platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document, 'script', 'twitter-wjs');</script>
            </div>
            <span class="g-plus" style="display:block !important; position: absolute !important; z-index: 199999; overflow:visible; margin-top:-20px !important; margin-right:0px !important;" data-height="15" data-action="share" data-annotation="none" data-href="http://www.iwine.com.tw/article.php?n_id=<?php echo $row_newest_article['n_id'];?>"></span-->
  ...
  <?php } ?>                        
      ...
      <?php do { ?>
        <div class="span3">
          <div style="margin-bottom:5px; padding:5px;">
            <div style="height:160px; overflow:hidden"> <a href="article.php?n_id=<?php echo $row_newest_article['n_id']; ?>" > <img src="http://admin.iwine.com.tw/webimages/article/<?php echo $row_newest_article['n_fig1']; ?>" alt="<?php echo $row_newest_article['n_title']; ?>"> </a> </div>
            <div style="height:50px; overflow:hidden">
            ...
            <div style="display:inline-block; z-index: 9999; overflow:hidden; height:20px;">
                ...
                <div style="float:left;padding-left:5px; z-index: 999; color:#949494; vertical-align:bottom;">
                <?php echo $row_newest_article['view_counter']; ?> 人次點閱
                </div>
            </div>
            <!-- fb like, fb share, twitter, g+ -->
            <!--div style="display:inline-block; z-index: 9999; overflow:hidden; height:20px;">
                <div style="">
                    <div class="fb-like" style="position: absolute; margin-top:-0px; margin-left:5px; overflow:hidden !important; z-index: 999; width:90px !important;" data-href="http://www.iwine.com.tw/article.php?n_id=<?php echo $row_newest_article['n_id']; ?>" data-layout="button_count" data-action="like" data-show-faces="false" data-share="false" data-width="90"></div>
                ...
                <div style="float:left; z-index: 9999; display: inline;">
                    <a href="https://twitter.com/share" class="twitter-share-button" data-url="http://www.iwine.com.tw/article.php?n_id=<?php echo $row_newest_article['n_id'];?>" data-via="draqula" data-lang="zh-tw" data-count="none">推文</a>
                        <script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0],p=/^http:/.test(d.location)?'http':'https';if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src=p+'://platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document, 'script', 'twitter-wjs');</script>
                </div>
                <div style="float:left; padding-left:5px; z-index: 9999; display: inline;">
                <div class="g-plusone" data-annotation="none" data-href="http://www.iwine.com.tw/article.php?n_id=<?php echo $row_newest_article['n_id'];?>"></div>
            ...
            <!--div align="right" style="position: absolute; z-index: 9999; overflow:visible; margin-top:-20px; margin-left:100px"> <a href="#" onclick="window.open('https://www.facebook.com/sharer/sharer.php?u='+encodeURIComponent('http://www.iwine.com.tw/article.php?n_id=<?php echo $row_newest_article['n_id']; ?>'),'facebook-share-dialog','width=626,height=436');return false;"><img src="images/fb.jpg"></a> </div>
            <div class="fb-like" style="position: absolute; z-index: 9999; overflow:visible; margin-top:-20px; margin-left:70px" data-href="http://www.iwine.com.tw/article.php?n_id=<?php echo $row_newest_article['n_id']; ?>" data-layout="button_count" data-show-faces="false" data-send="false" data-width="50"></div>
            <!--div align="right" style="position: absolute; z-index: 99999; overflow:visible; margin-top:-20px; margin-left:135px;">
                <a href="https://twitter.com/share" class="twitter-share-button" data-url="http://www.iwine.com.tw/article.php?n_id=<?php echo $row_newest_article['n_id'];?>" data-via="draqula" data-lang="zh-tw" data-count="none">推文</a>
                    <script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0],p=/^http:/.test(d.location)?'http':'https';if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src=p+'://platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document, 'script', 'twitter-wjs');</script>
            </div>
        ...
        <div class="span3">
          <div style="margin-bottom:5px; padding:5px;">
            ...
            <div style="display:inline-block; z-index: 9999; overflow:hidden; height:20px;">
                ...
                <div style="float:left;padding-left:5px; z-index: 999; color:#949494; vertical-align:bottom;">
                <?php echo $row_hotest_expert['view_counter']; ?> 人次點閱
                </div>
            </div>
            <img src="images/article_line.png">
            </div>
  ...
  <?php } ?>  
      ...
      <?php do { ?>    
        ...
        <a href="article.php?n_id=<?php echo $row_hotest_article['n_id']; ?>" >
        
        <img src="http://admin.iwine.com.tw/webimages/article/<?php echo $row_hotest_article['n_fig1']; ?>" alt="<?php echo $row_hotest_article['n_title']; ?>">
        </a>
        </div>
        <div style="height:50px; overflow:hidden">
        ...
        <div style="display:inline-block; z-index: 9999; overflow:hidden; height:20px;">
                ...
                <?php echo $row_hotest_article['view_counter']; ?> 人次點閱
                </div>
        </div>
        <!--div style="display:inline-block; z-index: 9999; overflow:hidden; height:20px;">
                <div style="">
                    <div class="fb-like" style="position: absolute; margin-top:-0px; margin-left:5px; overflow:hidden !important; z-index: 999; width:90px !important;" data-href="http://www.iwine.com.tw/article.php?n_id=<?php echo $row_hotest_article['n_id']; ?>" data-layout="button_count" data-action="like" data-show-faces="false" data-share="false" data-width="90"></div>
                ...
                <div style="float:left; z-index: 9999; display: inline;">
                    <a href="https://twitter.com/share" class="twitter-share-button" data-url="http://www.iwine.com.tw/article.php?n_id=<?php echo $row_hotest_article['n_id'];?>" data-via="draqula" data-lang="zh-tw" data-count="none">推文</a>
                        <script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0],p=/^http:/.test(d.location)?'http':'https';if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src=p+'://platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document, 'script', 'twitter-wjs');</script>
                </div>
                <div style="float:left; padding-left:5px; z-index: 9999; display: inline;">
                <div class="g-plusone" data-annotation="none" data-href="http://www.iwine.com.tw/article.php?n_id=<?php echo $row_hotest_article['n_id'];?>"></div>
        ...
        <a href="#" onclick="window.open('https://www.facebook.com/sharer/sharer.php?u='+encodeURIComponent('http://www.iwine.com.tw/article.php?n_id=<?php echo $row_hotest['n_id']; ?>'),'facebook-share-dialog','width=626,height=436');return false;"><img src="images/fb.jpg"></a>
          ...
          <div class="fb-like" data-href="http://www.iwine.com.tw/article.php?n_id=<?php echo $row_hotest_article['n_id']; ?>" data-layout="button_count" data-show-faces="false" data-send="false" style="position: absolute; z-index: 9999; overflow:visible; margin-top:-20px; margin-left:60px"></div-->
           <img src="images/article_line.png">
          </div>
          </div>              
