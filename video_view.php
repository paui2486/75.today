...
*/
mysql_select_db($database_iwine, $iwine);
$query_other = "SELECT * FROM vedio WHERE id <> '$a_id' ORDER BY RAND() LIMIT 3";
...
if (isset($_GET['id'])) {
	$id = $_GET['id'];
mysql_select_db($database_iwine, $iwine);
$sql ="SELECT * FROM `vedio` where id = '$id'";//搜尋語句 vedioDB
        ...
        <div id="MainContent" class="span9">
          <!--div class="row">
            ...
            <ul class="breadcrumb">
                ...
                <li><a href="video_list.php">影片情報</a> <span class="divider">/</span></li>
            ...
            <div class="row" style="border:#000000 solid 0px; margin-left:0px; margin-bottom:10px">
                ...
                <div class="span8">
                    <h2><img src="images/wine_icon1.png" width="35" height="35">影片情報</h2>
...
<div class="span8" style="display: block; overflow:hidden;">
	...
	<div style="float:left; z-index: 999;"><!--fb分享--><!--注意分享網址 資料庫欄位-->
        <a href="#" onclick="window.open('https://www.facebook.com/sharer/sharer.php?u='+encodeURIComponent('http://www.iwine.com.tw/video_view.php?id=<?php echo $row['id']; ?>'),'facebook-share-dialog','width=626,height=436');return false;"><img src="images/fb.png"></a>
    </div>
	<!--fb SHARE END -->
                ...
                <div class="span8" style="padding:0px">
                    <h2 class="winetast_title"><?php echo $row['title']; ?></h2>
                        ...
                        <div class="article_txt" style="margin-top:20px; margin-bottom:50px">
                            <img src="http://admin.iwine.com.tw/webimages/symposium/<?php echo $row['pic1']?>" width="694" height="442">
                            <br>
                            <br>
                    ...
                    <div class="row">
                        ...
                        <div class="span12">
                          <?php if($totalRows_other > 0){ ?>
                              <h4><br>
                              <img src="images/wine_icon1.png" width="35" height="35"> <span class="title">更多影片：</span><br>
                              </h4>
                              <?php do { ?>
                              <div class="span3">
                                <div style="border:solid 0px #000000; margin-bottom:20px;">
                                  <div style="height:199px; overflow:hidden"> 
                                    <a href="symposium.php?id=<?php echo $row_other['id']; ?>" > 
                                        <img src="http://admin.iwine.com.tw/webimages/symposium/<?php echo $row_other['pic1']; ?>" alt="<?php echo $row_other['title']; ?>" > 
                                    </a> 
                                  </div>
