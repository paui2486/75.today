            ...
            <div class="span9">
              ...
              <div>
                <form action="regist_check_supplier.php" method="post" enctype="multipart/form-data" class="form-horizontal" id="form1" >
                	<img src="images/wine_icon1.png" width="49" height="49"><span class="title">酒商註冊會員</span><img src="images/line03.png" width="1000">
                    <span class="span8"></span>

                    <div class="hero-unit02" style="border:solid 0px #000000; margin-bottom:5px; padding:5px; background-image:url(images/bg2.png)"> <span class="massage">馬上加入iWine <span class="title">酒商會員</span>!
                  ...
                  <div class="control-group">
				    <label class="control-label" for="account"><span class="memo">*</span>帳 號</label>
  					...
  					<div class="control-group">
    					<label class="control-label" for="passwd"><span class="memo">*</span>密 碼</label>
    					<div class="controls">
      					<input type="password" id="passwd" name="passwd" placeholder="請輸入密碼">
                        <span class="help-inline">*請輸入6碼以上的英文或數字</span>
   					  </div>
				  </div>
                    <div class="control-group">
   					  <label class="control-label" for="passwd_confirm"><span class="memo">*</span>電話 </label>
    					<div class="controls">
      					<input type="password" id="passwd_confirm" name="passwd_confirm" placeholder="請再次輸入密碼">
      					<span class="help-inline">*輸入格式如：0988123789</span></div>
				  </div>
                    <div class="control-group">
						<label class="control-label" for="name"><span class="memo">*</span>e-mail</label>
						<div class="controls">
						<input id="name" name="name" type="text" placeholder="請輸入姓名">
						</div>
                    </div>
                    <div class="control-group">
						<label class="control-label" for="year"><span class="memo">*</span>公司名稱</label>
						<div class="controls">
						<input id="mobile9" name="mobile9" type="text" placeholder="請輸入手機號碼">
					  </div>   
					</div>
                    <div class="control-group">
						<label class="control-label" for="mobile">負責人</label>
						<div class="controls">
						<input id="mobile" name="mobile" type="text" placeholder="請輸入手機號碼">
						</div>   
					</div>
                  <div class="control-group">
                    <div class="control-group">
    <label class="control-label" for="mobile2">聯絡人</label>
    <div class="controls">
      <input id="mobile2" name="mobile2" type="text" placeholder="請輸入手機號碼">
    </div>
  </div>
  <div class="control-group">
    <label class="control-label" for="mobile3">地址</label>
    <div class="controls">
      <input id="mobile3" name="mobile3" type="text" placeholder="請輸入手機號碼">
    </div>
  </div>
  <div class="control-group">
    <label class="control-label" for="mobile4">傳真</label>
    <div class="controls">
      <input id="mobile4" name="mobile4" type="text" placeholder="請輸入手機號碼">
    </div>
  </div>
  <div class="control-group">
    <label class="control-label" for="mobile5">統一編號</label>
    <div class="controls">
      <input id="mobile5" name="mobile5" type="text" placeholder="請輸入手機號碼">
    </div>
  </div>
                  </div>
