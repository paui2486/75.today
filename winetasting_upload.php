              ...
              <div>
                <form action="regist_check.php" method="post" enctype="multipart/form-data" class="form-horizontal" id="form1" >
                  ...
                  <div class="control-group">
				    <label class="control-label" for="m_account"><span class="memo">*</span>標 題</label>
    					<div class="controls">
    					  <input id="m_mobile12" name="m_mobile12" type="text">
    					  <span class="help-stock"><div id="account_check" style="color:#F00"></div></span>
   					</div>
				  </div>
  					<div class="control-group">
    					<label class="control-label" for="m_passwd"><span class="memo">*</span>分 類</label>
    					<div class="controls">
                    ...
                    <div class="control-group">
    					...
    					<div class="controls">
    					  <input id="m_mobile11" name="m_mobile11" type="text">
    					</div>
				  </div>
                    <div class="control-group">
						<label class="control-label" for="m_name"><span class="memo">*</span>繳費期限</label>
						<div class="controls">
						  <input id="m_mobile10" name="m_mobile9" type="text">
						</div>
                    </div>
                    <div class="control-group">
						<label class="control-label" for="m_year"><span class="memo">*</span>區域</label>
						<div class="controls">
                    ...
                    <div class="control-group">
						<label class="control-label" for="m_mobile"><span class="memo">*</span>活動地點</label>
						<div class="controls">
						  <input id="m_mobile" name="m_mobile" type="text">
						</div>   
					</div>
                  <div class="control-group">
                    <div class="control-group">
    <label class="control-label" for="m_mobile2"><span class="memo">*</span>活動地址</label>
    <div class="controls">
      <input id="m_mobile2" name="m_mobile2" type="text">
    </div>
  </div>
  <div class="control-group">
    <label class="control-label" for="m_mobile3"><span class="memo">*</span>費用</label>
    <div class="controls">
      <input id="m_mobile3" name="m_mobile3" type="text">
    </div>
  </div>
  <div class="control-group">
    <label class="control-label" for="m_mobile4"><span class="memo">*</span>主辦單位</label>
    <div class="controls">
      <input id="m_mobile4" name="m_mobile4" type="text">
    </div>
  </div>
  <div class="control-group">
    <label class="control-label" for="m_mobile5"><span class="memo">*</span>主講人</label>
    <div class="controls">
      <input id="m_mobile5" name="m_mobile5" type="text">
    </div>
  </div>
  <div class="control-group">
    <label class="control-label" for="m_mobile6">講師介紹</label>
    <div class="controls">
      <input id="m_mobile6" name="m_mobile6" type="text">
    </div>
  </div>
  <div class="control-group">
    <label class="control-label" for="m_mobile7"><span class="memo">*</span>酒單</label>
    <div class="controls">
      <input id="m_mobile7" name="m_mobile7" type="text">
    </div>
  </div>
  <div class="control-group">
    <label class="control-label" for="m_mobile8">活動介紹</label>
    <div class="controls">
      <input id="m_mobile8" name="m_mobile8" type="text">
    </div>
  </div>
  <div class="control-group">
    <label class="control-label" for="m_mobile9"><span class="memo">*</span>報名方式</label>
    <div class="controls">
      <input id="m_mobile9" name="m_mobile10" type="text">
    </div>
  </div>
  <div class="control-group">
    <label class="control-label" for="m_mobile10"><span class="memo">*</span>上傳照片一</label>
    <div class="controls">
      <input type="file" name="fileField" id="fileField">
    </div>
  </div>
  <div class="control-group"><span class="control-label">上傳照片二</span>
    <div class="controls">
      <input type="file" name="fileField2" id="fileField2">
    </div>
  </div>
  <div class="control-group"><span class="control-label">上傳照片三</span>
    <div class="controls">
      <input type="file" name="fileField3" id="fileField3">
    </div>
  </div>
  <div class="control-group"><span class="control-label">上傳照片四</span>
    <div class="controls">
      <input type="file" name="fileField4" id="fileField4">
    </div>
  </div>
  <div class="control-group"><span class="control-label">上傳照片五</span>
    <div class="controls">
      <input type="file" name="fileField5" id="fileField5">
                    ...
                    <div class="control-group">
    					<div class="controls">
      					...
      					<button type="button" class="btn btn-danger" onClick="chkform();">確定上傳</button>
