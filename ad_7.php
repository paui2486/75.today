...
$query_AD01 = "SELECT * FROM ad_fig WHERE b_position = '7' AND b_status = 'Y' ORDER BY RAND() LIMIT 1";
...
<div class="span3">
<h4 align="left"><img src="images/wine_icon1.png" width="30" height="30"> iWine 小百科</h4>
<?php if ($totalRows_AD01 > 0) { // Show if recordset not empty ?>
   <div style="margin-bottom:10px; min-height:270px; max-height:325px; overflow:hidden;" align="center">
