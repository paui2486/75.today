...
$query_member_check = sprintf("SELECT * FROM wine_supplier WHERE account = '%s'", GetSQLValueString($colname_member_check, "text"));
...
if($_POST['check_form'] == "Y"){ 
 ...
 $insertSQL = sprintf("INSERT INTO wine_supplier (account, password_md5, company_name, owner, contact, address, telphone, fax, email, vat_num, last_login, regist_date) 
...
mysql_select_db($database_iwine, $iwine);
$query_member = "SELECT * FROM wine_supplier WHERE id = '".$_new_m_id."'";
    ...
    <td height=\"150\" align=\"center\" valign=\"middle\" background=\"http://www.iwine.com.tw/images/mail_bg.gif\"><table width=\"600\" border=\"0\" cellspacing=\"0\" cellpadding=\"5\">
      <tr>
        <td><p>親愛的 ".$_POST['company_name']." 您好：</p>
          <p> 感謝您加入成為本網站合作夥伴會員，請妥善保管本信，內含個人會員資訊！</p>
          <p>您申請的身分別是： 酒商合作夥伴，登入時請選擇酒商身分別。</p>
