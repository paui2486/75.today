...
$query_newest = "SELECT * FROM article WHERE n_status = 'Y' ORDER BY n_date DESC LIMIT 6";
...
mysql_select_db($database_iwine, $iwine);
$query_hotest = "SELECT * FROM article WHERE n_status = 'Y' ORDER BY RAND() LIMIT 6";
...
<script>(function(d, s, id) {
  ...
  fjs.parentNode.insertBefore(js, fjs);
    ...
    <div class="container">
						...
						<?php do { ?>
   					    <div class="<?php if($i==1){ ?>active <?php } ?>item"><a href="<?php echo $row_index_fig['b_url']; ?>"><img src="http://admin.iwine.com.tw/webimages/index/<?php echo $row_index_fig['b_file']; ?>"></a>
                            ...
                            <?php if($row_index_fig['b_subname'] <> ""){ ?>
                              <p><?php echo $row_index_fig['b_subname']; ?></p>
                            <?php } ?>
    					      </div>
   					      </div>
                          <?php $i++; ?>
	  ...
	  <?php do { ?>    
		...
		<a href="article.php?n_id=<?php echo $row_newest['n_id']; ?>" >
        <img src="http://admin.iwine.com.tw/webimages/article/<?php echo $row_newest['n_fig1']; ?>" alt="<?php echo $row_newest['n_title']; ?>">
        </a>
        </div>
        <div style="height:50px; overflow:hidden">
          <h5><a href="article.php?n_id=<?php echo $row_newest['n_id']; ?>"><?php echo $row_newest['n_title']; ?></a><br>
            <img src="images/article_line.png">          </h5>
        </div>
        <div style="height:20px"></div>
        <div class="fb-like" data-href="http://www.iwine.com.tw/article.php?n_id=<?php echo $row_newest['n_id']; ?>" data-layout="button_count" data-show-faces="false" data-send="false" data-width="100" style="position: absolute; z-index: 9999; overflow:visible; margin-top:-20px"></div>
        <div align="right">
  ...
  <?php } ?>
	  ...
	  <?php do { ?>    
        ...
        <div style="height:20px"></div>
          <div class="fb-like" data-href="http://www.iwine.com.tw/article.php?n_id=<?php echo $row_hotest['n_id']; ?>" data-layout="button_count" data-show-faces="false" data-send="false" style="position: absolute; z-index: 9999; overflow:visible; margin-top:-20px"></div>
          <div align="right">
  ...
  <?php } ?>
     ...
     <div class="row">
        <div class="span3" align="center">
     	   <h4 align="left"><img src="images/wine_icon1.png" width="30" height="30"> iWine嚴選<br>
   	       <img src="images/line02.png">     	   </h4>
        	<?php include('ad_1.php'); ?>
        </div>
        <div class="span3">
     	   <h4 align="left"><img src="images/wine_icon1.png" width="30" height="30"> 粉絲團最新動態<br>
   	       <img src="images/line02.png">     	   </h4>
           <div class="fb-like-box" data-href="https://www.facebook.com/IwineAiWoJiuJiu" data-width="270" data-show-faces="true" data-stream="true" data-header="true"></div>
        </div>
