...
<div style="display: block; overflow:hidden;">
    ...
    <div style="float:left; padding-left:10px; width:60px;">
        <div class="fb-like" data-href="<?php echo curPageURL(); ?>" data-layout="box_count" data-action="recommend" data-show-faces="true" data-share="false"></div>
    </div>
...
//do something with this information
    if( $iPhone || $Android){ ?>
                ...
                <a href="http://line.naver.jp/R/msg/text/?<? echo $row_article['title']; ?>：<?php echo $row_article['title'] ?>%0D%0A<?php echo curPageURL(); ?>"><img src="images/linebutton_20x20.png"></a>
                </div>
    <?php } ?> 
    ...
    <div style="float:left; padding-left:10px; padding-right:10px; height:70px;">
        <a href="http://service.weibo.com/share/share.php?title=<?php echo $row_article['title']; ?>&url=<?php echo curPageURL(); ?>" target="_blank" title="分享到新浪微博">
