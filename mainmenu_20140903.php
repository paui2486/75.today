...
<a class="brand" href="index.php"><img src="webimages/c.png"></a>
...
<div class="nav-collapse collapse">
    ...
    <!--<li class="divider-vertical"></li>-->
     ...
     <!--<form class="navbar-form pull-left" action="article_search.php">
  		<input name="keyword" type="text" class="input02-large search-query" id="keyword" placeholder="" maxlength="35">
