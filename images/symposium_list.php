    ...
    <?php if($total_symposium > 0) {?>
        <table width="100%" height="145"  border="0" >
           <tr>
             ...
             <td width="42" background="images/bg2.png"> </td>
             
             <th width="271" background="images/bg2.png">活動主題 </th>
             <th width="107" background="images/bg2.png">日期</th>
             <th width="72" background="images/bg2.png">區域</th>
             <th width="247" background="images/bg2.png">地點</th>
             <th width="35"  background="images/bg2.png"> 費用</th>
           </tr>
           <?php while($symposium = mysql_fetch_assoc($symposium_query)) {
                ...
                if( strtotime($now) > strtotime($date_time) ){ ?>
                   <tr class="symposium_table">
                   <td><img src="images/icon_note.jpg"></td>
                     ...
                     <td align="left" class="passed_item"><?php echo $symposium['location']; ?></td>
      ...
      <td><img src="images/icon_note.jpg"></td>
                         ...
                         <td align="left" ><?php echo $symposium['location']; ?></td>
