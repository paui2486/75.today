...
$query_article = "SELECT * FROM article ORDER BY n_id DESC LIMIT ".$_start.",8";
...
<html lang="zh_tw">
  ...
  <head>
    <meta charset="utf-8">
    <title>寵物寫真集 - iWine -- 禁止酒駕．未滿18歲禁止飲酒</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="">
    <meta name="author" content="">
    <meta property="og:title" content="寵物寫真集 - iWine -- 禁止酒駕．未滿18歲禁止飲酒">
...
<script>(function(d, s, id) {
  ...
  fjs.parentNode.insertBefore(js, fjs);
    ...
    <div id="container_w" style="background-image:url(images/bg.png)">    
	  <?php do { ?>
        <div class="item_w">
